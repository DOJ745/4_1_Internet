...
namespace LB5
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="A", Namespace="http://schemas.datacontract.org/2004/07/LB5")]
...
public interface IWCFSiplex
{
    ...
    LB5.A Sum(LB5.A objOne, LB5.A objTwo);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFSiplex/Sum", ReplyAction="http://tempuri.org/IWCFSiplex/SumResponse")]
    System.Threading.Tasks.Task<LB5.A> SumAsync(LB5.A objOne, LB5.A objTwo);
}
...
public partial class WCFSiplexClient : System.ServiceModel.ClientBase<IWCFSiplex>, IWCFSiplex
{
    ...
    public LB5.A Sum(LB5.A objOne, LB5.A objTwo)
    {
        return base.Channel.Sum(objOne, objTwo);
    }
    
    public System.Threading.Tasks.Task<LB5.A> SumAsync(LB5.A objOne, LB5.A objTwo)
    {
